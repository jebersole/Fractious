...
def Argue(param):
    ...
    parser.add_argument('--zoom', metavar='Z', type=str, default='default',
                        help='zoom factor, e.g. 2')
    parser.add_argument('--pan', metavar='P', type=str, default='default',
                        help='pan in x or y directions, e.g. [-1,1.5]')
    parser.add_argument('--iters', metavar='I', type=str, default='default',
